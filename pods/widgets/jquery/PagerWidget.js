...
AjaxSolr.PagerWidget = AjaxSolr.AbstractWidget.extend(
  ...
  renderLinks: function (links) {
    if (this.totalPages) {
      links.unshift(this.pageLinkOrSpan(this.previousPage(), [ 'pager-disabled', 'pager-prev' ], '<i class="icon fa-chevron-left"></i> PREVIOUS'));
      links.push(this.pageLinkOrSpan(this.nextPage(), [ 'pager-disabled', 'pager-next' ], 'NEXT <a class="icon fa-chevron-right"></a>'));
